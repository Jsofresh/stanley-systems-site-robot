  ...
  return (
    ...
    >
      <div className="flex items-center justify-between w-full gap-x-6 sm:gap-x-8">
        <div className="text-white font-semibold text-sm sm:text-base">Stanley Systems</div>
        ...
        <div className="hidden sm:flex items-center gap-2 sm:gap-3">
          ...
          <a
            ...
            className="relative z-10 px-4 py-2 sm:px-3 text-xs sm:text-sm font-semibold text-white bg-gradient-to-br from-blue-400 to-blue-600 rounded-full hover:from-blue-500 hover:to-blue-700 transition-all duration-200"
          >
            Book Call
          </a>
        </div>
